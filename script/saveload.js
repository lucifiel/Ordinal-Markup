...
function getSaveName() {
  return inPublicTesting() ? 'ordinalMarkupPublicTestingSave' : 'ordinalMarkupSave';
}

function load() {
  try {
    const token = getSaveName()
    if (token in localStorage) {
      const stored = localStorage[token];
      const loadgame = JSON.parse(atob(stored));
...
function handlePost0211Saves() {
  ...
  if (game.version === 0.34) {
    if (game.darkManifolds>=1e128) {
      ...
      localStorage[getSaveName()] = ""
...
function save() {
  if (AF === 0) {
    localStorage.setItem(getSaveName(), btoa(JSON.stringify(game)));
  }
}
